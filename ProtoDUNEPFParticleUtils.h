...
namespace protoana {
  ...
  public:
    ...
    const std::vector< art::Ptr< recob::Hit > > GetPFParticleHitsArtPtr( const recob::PFParticle &particle, art::Event const &evt, const std::string particleLabel) const;
    
    /// Get the hits associated to the PFParticle from a plane
    const std::vector<const recob::Hit*> GetPFParticleHitsFromPlane(const recob::PFParticle &particle, art::Event const &evt, const std::string particleLabel, const unsigned int planeID) const;
    ...
    /// Get the number of hits from a plane
    unsigned int GetNumberPFParticleHitsFromPlane(const recob::PFParticle &particle, art::Event const &evt, const std::string particleLabel, const unsigned int planeID) const; 
